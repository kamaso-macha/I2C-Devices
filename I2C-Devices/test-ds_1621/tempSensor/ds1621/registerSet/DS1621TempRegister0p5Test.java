 ...
 * **********************************************************************
 * PROJECT       : I2CDevices
 * FILENAME      : DS1621TempRegister0p5Test.java
 *
...
class DS1621TempRegister0p5Test {

	private final Logger logger = LoggerFactory.getLogger(DS1621TempRegister0p5Test.class.getName());

	private class TestDS1621TempRegister0p5 extends DS1621TempRegister0p5 {

		public TestDS1621TempRegister0p5(I2C aI2cDevice, DS1621TemperatureStatusFlags aStatusFlags) {
	...
	/**
	 * Test method for {@link tempSensor.ds1621.registerSet.DS1621TempRegister0p5#DS1621TempRegister0p5(com.pi4j.io.i2c.I2C, tempSensor.ds1621.registerSet.DS1621TemperatureStatusFlags)}.
	 */
	@Test
	void testDS1621TempRegister0p5() {
		logger.info("testDS1621TempRegister0p5()");
	...
	} // testDS1621TempRegister0p5()
	

	/**
	 * Test method for {@link tempSensor.ds1621.registerSet.DS1621TempRegister0p5#readTemperature()}.
	 */
	@Test
	void testReadTemperature() {
		...
		try {
			...
			cut = new TestDS1621TempRegister0p5(i2cDevice, statusFlags);
