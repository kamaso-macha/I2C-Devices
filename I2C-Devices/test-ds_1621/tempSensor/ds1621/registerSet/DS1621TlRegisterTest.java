 ...
 * **********************************************************************
 * PROJECT       : I2CDevices
 * FILENAME      : DS1621TlRegisterTest.java
 *
...
class DS1621TlRegisterTest {

	private final Logger logger = LoggerFactory.getLogger(DS1621TlRegisterTest.class.getName());

	COMMAND_SET commandSet = COMMAND_SET.ACCESS_TL;
	int command = commandSet.value; 
	DataType dataType = DataType.WORD;

	private class TestDS1621TlRegister extends DS1621TlRegister {

		public TestDS1621TlRegister(I2C aI2cDevice, DS1621TemperatureStatusFlags aStatusFlags) {
	...
	void setUp() throws Exception {
		...
		cut = new TestDS1621TlRegister(i2cDevice,statusFlags);
	...
	/**
	 * Test method for {@link tempSensor.ds1621.registerSet.DS1621TlRegister#DS1621TlRegister(com.pi4j.io.i2c.I2C, tempSensor.ds1621.registerSet.DS1621TemperatureStatusFlags)}.
	 */
	@Test
	void testDS1621TlRegister() {
		logger.info("testDS1621TlRegister()");
		...
		thrown = assertThrows(IllegalArgumentException.class, () 
			-> new DS1621TlRegister(i2cDevice, null));
		assertEquals("aStatusFlags can't be null.", thrown.getMessage());
		
		assertDoesNotThrow(() -> new DS1621TlRegister(i2cDevice, statusFlagsMock));

	} // testDS1621TlRegister()
