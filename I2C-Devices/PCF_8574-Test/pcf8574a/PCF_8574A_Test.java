...
public class PCF_8574A_Test {		 // NOSONAR

	private final Logger logger = LoggerFactory.getLogger(PCF_8574A_Test.class.getName());

	private PCF_8574A pcf8574a;
	 ...
	 * 
	 */
	public PCF_8574A_Test() {
		
		System.out.println("PCF_8574A_Test()");		// NOSONAR
	...
	private void rdByte() throws I2CErrorException {
		...
		logger.info("PCF_8574A rdByte: {}", String.format("rdByte byte 0x%02X", pcf8574a.readByte()));		// NOSONAR
	...
	private void wrByte() throws I2CErrorException {
		...
		logger.info("PCF_8574A wrByte: {}", String.format("wrByte byte 0x%02X", value));
		
		pcf8574a.writeByte(value);
	...
	protected void toggle() {
		...
		do { // NOSONAR
			...
			try {
				...
				logger.info("PCF_8574A wr: {}", String.format("toggle byte 0x%02X", value));

				pcf8574a.writeByte(value);
				
				logger.info("PCF_8574A rd: {}", String.format("toggle byte 0x%02X", pcf8574a.readByte()));
	...
	private void init(final String[] args) {
		...
		pcf8574a = new PCF_8574A(PCF_8574_Cli.bus, PCF_8574_Cli.getAddress());		 // NOSONAR
	...
	public static void main(final String[] args) {
		...
		PCF_8574A_Test myself = new PCF_8574A_Test();
