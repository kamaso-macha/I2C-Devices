...
CLASS_PATH=.:./bin/PCF_8574A-Test-1.1.1.jar

CLASS_PATH=$CLASS_PATH:./lib/PCF_8574A-1.1.2.jar

#rem
#rem   L I B R A R Y    s e c t i o n
#rem

CLASS_PATH=$CLASS_PATH:./lib/I2C-Device-1.1.2.jar
...
/usr/bin/java -cp $CLASS_PATH pcf8574a.PCF_8574A_Test $@
