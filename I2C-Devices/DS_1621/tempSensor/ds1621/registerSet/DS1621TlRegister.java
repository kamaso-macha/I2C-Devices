 ...
 * **********************************************************************
 * PROJECT       : I2CDevices
 * FILENAME      : DS1621TlRegister.java
 *
...
public class DS1621TlRegister extends DS1621RegisterBase implements RWRegisterFloat {

    private final Logger logger = LoggerFactory.getLogger(DS1621TlRegister.class.getName());
	 ...
	 * @param address
	 */
	public DS1621TlRegister(final I2C aI2cDevice, final DS1621TemperatureStatusFlags aStatusFlags) {
		super(aI2cDevice, COMMAND_SET.ACCESS_TL, DataType.WORD);
