 ...
 * **********************************************************************
 * PROJECT       : I2CDevices
 * FILENAME      : Lm75TempRegisterTest.java
 *
...
class Lm75TempRegisterTest {

	private final Logger logger = LoggerFactory.getLogger(Lm75TempRegisterTest.class.getName());

	private class TestLm75TempRegister extends Lm75TempRegister {

		public TestLm75TempRegister(I2C aI2cDevice) { super(aI2cDevice); }
	...
	void setUp() throws Exception {
		...
		cut = new TestLm75TempRegister(i2cMock);
	...
	/**
	 * Test method for {@link tempSensor.lm75.registerSet.Lm75TempRegister#Lm75TempRegister(com.pi4j.io.i2c.I2C)}.
	 */
	@Test
	void testLm75TempRegister() {
		logger.trace("testLm75TempRegister()");
	...
	/**
	 * Test method for {@link tempSensor.lm75.registerSet.Lm75TempRegisterBase#write(float)}.
	 */
	@Test
	void testWrite() {
