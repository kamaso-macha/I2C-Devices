...
public enum COMP_MODE implements ConfigParameter {
	...
	public static final int LSB_POSITION	= 4;
	
	public final int value;
	
	private COMP_MODE(final int aValue) { value = aValue; }
