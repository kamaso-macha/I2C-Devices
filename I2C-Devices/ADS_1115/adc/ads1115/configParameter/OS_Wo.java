...
public enum OS_Wo implements ConfigParameter {
	
//	NO_EFFECT					(0b0)
	START_SINGLE_CONVERSION		(0b1)
	;
	
	public static final int SIZE			= 1;
	public static final int LSB_POSITION	= 15;
	
	public final int value;
	
	private OS_Wo(final int aValue) { value = aValue; }
