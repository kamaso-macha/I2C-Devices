...
public class PCF_8574 extends PCF_8574_Impl { // NOSONAR

	private final Logger logger = LoggerFactory.getLogger(PCF_8574.class.getName());

	protected static final byte ADR_LOW	= 0x20;
	protected static final byte ADR_HIG	= 0x27;
	 ...
	 * @param aI2cAddress
	 */
	public PCF_8574(int aI2cBusNbr, int aI2cAddress) {
