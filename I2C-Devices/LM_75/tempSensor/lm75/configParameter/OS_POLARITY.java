...
public enum OS_POLARITY implements ConfigParameter {
	...
	public static final int LSB_POSITION	= 2;
	
	public final int value;
	
	private OS_POLARITY(final int aValue) { value = aValue; }
