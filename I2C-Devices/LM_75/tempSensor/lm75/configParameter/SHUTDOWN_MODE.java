...
public enum SHUTDOWN_MODE implements ConfigParameter {
	...
	public static final int LSB_POSITION	= 0;
	
	public final int value;
	
	private SHUTDOWN_MODE(final int aValue) { value = aValue; }
